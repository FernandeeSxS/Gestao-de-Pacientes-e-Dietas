...
#define M 40
#define L 50
#define E 5 //se alterarem o número de pacientes basta mudar este valor para a nova quantidade
...
#pragma warning (disable: 4996)
 ...
 // Definição de um enumerado chamado Refeicao para representar tipos de refeições
...
typedef struct Dieta {
	...
	// Achamos mais produtivo pôr em vez de uma variável para a data apenas por uma data inicio e uma data fim 
